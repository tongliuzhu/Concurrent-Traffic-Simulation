...
Intersection::Intersection(int id) : _trafficLight(id), _intersectionId(id)
{
...
bool Intersection::trafficLightIsGreen(TrafficLightPhase& color)
{
   ...
   {
       color = TrafficLightPhase::green;
       return true;
   }
   else if (_trafficLight.getCurrentPhase() == TrafficLightPhase::yellow)
   {
       color = TrafficLightPhase::yellow;
       return false;
   }
   else
   {
       color = TrafficLightPhase::red;
       return false;
   }
